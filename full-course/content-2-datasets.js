      ...
      quiz: [
        {
          ...
          options: ["Random web text", "Prompt → ideal-answer example pairs", "Only questions, no answers", "Images"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["Having the most examples possible", "High quality and consistent style of examples", "Using the longest answers", "Avoiding any structure"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["A faster model", "A model that follows instructions and does tasks", "A smaller model", "An image generator"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["It looks impressive", "So the model learns the general skill and can handle new, unseen instructions", "It saves money", "It reduces file size"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["A prompt and one answer", "A prompt with a chosen (better) and rejected (worse) answer", "Two unrelated questions", "An image and a caption"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["New factual knowledge", "Which kind of answer people prefer (better vs worse)", "How to tokenize", "Faster inference"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["Data collected only from humans", "Training examples generated by an AI model", "Encrypted data", "Data with no labels"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["It's always too small", "It inherits the generating model's errors, biases, and blandness", "It can't be stored", "It's illegal"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["Writing model code", "Deciding which data to include, exclude, and balance", "Running the model", "Counting tokens"],
          answer: 1,
          why: "Curation is the human judgement of selecting and balancing the training data.",
        },
        {
          q: "Why is curation so important?",
          options: ["It speeds up the GPU", "The model absorbs whatever you feed it — garbage in, garbage out", "It reduces electricity use", "It changes the architecture"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["Adding more layers to the model", "Removing duplicates, junk formatting, and private data", "Buying a bigger GPU", "Increasing the context window"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["It makes files prettier", "Duplicates secretly over-train the model on repeated text", "It adds new facts", "It speeds up the internet"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["As one long paragraph", "As roles and messages (system / user / assistant), often in JSON", "As images", "As spreadsheets only"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["It changes the model size", "Using the wrong one is a common reason fine-tuning fails or behaves oddly", "It encrypts the data", "It has no effect"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["Training a model from scratch", "A small, focused round of extra training on an already-trained model", "Counting tokens", "Compressing a model"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["Adding facts that change daily", "Teaching consistent behaviour and style", "Speeding up the internet", "Making the screen brighter"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["It's cheaper", "It trains on large amounts of raw domain text rather than instruction/answer pairs", "It uses no data", "It only changes the name"],
          answer: 1,
        ...
        },
        {
          ...
          options: ["For any small tweak", "When a model needs deep knowledge of a specialised domain it barely saw", "To make text shorter", "To reduce token cost"],
          answer: 1,
      ...
      quiz: [
        {
          ...
          options: ["The model is broken", "It predicts plausible text, and plausible isn't always true", "Bad internet", "Too few tokens"],
          answer: 1,
          why: "Models optimise for likely-sounding text, which can be confidently wrong.",
        },
        {
          q: "Which most reliably reduces hallucinations?",
          options: ["Asking more politely", "Grounding answers in real retrieved documents and allowing “I don't know”", "Using a darker theme", "Making the prompt longer for no reason"],
          answer: 1,
