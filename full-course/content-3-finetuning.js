...
window.COURSE.push({
  ...
  topics: [
...

    {
      ...
      analogy:
        "<p>Old way (RLHF): hire a separate judge, train the judge, then coach the student against the judge's scores — many moving parts. DPO: just show the student thousands of “this answer beats that answer” comparisons and let them adjust directly. Fewer steps, similar result.</p>",
      mentalModel:
